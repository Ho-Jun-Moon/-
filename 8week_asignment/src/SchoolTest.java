...
public class SchoolTest {
    ...
    while ( true ) {
        ...
        System.out.printin("Invalid Operation!") ;
        continue ;
        }
    switch ( cmd ) {
    case ADD : {
    ...
    case LIST: System.out.printIn(pnu) ; break ;
    default: break;
    }
    }
    }
    ...
    System.out.printIn(foundStudent) ;
    else
    System.out.printIn("Student Not Found with name " + studentName+ " and year" + schoolYear) ;
    }

    private static Command getCommand(final Scanner scanner) {
        System.out.print("Enter Command String! ");
        final String commandStr = scanner.nextQ.toUpperCase();
